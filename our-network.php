...
<div class="banner-wrapper has_background">
    ...
    <div class="banner-wrapper-inner">
        <h1 class="page-title" style="color:#fff;">Our Networks</h1>
        <div role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
            <ul class="trail-items breadcrumb">
                <li class="trail-item trail-begin"><a href="index.php"><span style="color:#fff;">Home</span></a></li>
                <li class="trail-item trail-end active"><span style="color:#fff;">Our Networks</span>
                </li>
            </ul>
        </div>
    </div>
...
<div class="site-main main-container no-sidebar" style="padding-top:0px;">
    ...
    <div class="section-042">
        <div class="container">
            <div class="row">
                <div class="col-md-12 offset-xl-2 col-xl-10 col-lg-12">
                    <div class="row">
                        
                        <div class="col-md-12">
                            <img src="assets/images/vishal-print/india.jpg" alt="Our Networks" />
                        </div>
                    </div>
                </div>
            </div>
