...
<head>
    ...
    <title>Vishal Sarees | Forgot Password</title>
	<?php 
	include('head.php');
	?>
</head>
...
<div class="banner-wrapper has_background">
    ...
    <div class="banner-wrapper-inner">
        <h1 class="page-title" style="color:#fff;">Forgot Password</h1>
        <div role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
            <ul class="trail-items breadcrumb">
                <li class="trail-item trail-begin"><a href="index.php"><span style="color:#fff;">Home</span></a></li>
                <li class="trail-item trail-end active"><span style="color:#fff;">Forgot Password</span>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="page-main-content">
                    <div class="akasha">
                        ...
                        <div class="u-columns col2-set" id="customer_login">
                            <div class="u-column1 col-1" style="min-height:400px;width:100%;">
