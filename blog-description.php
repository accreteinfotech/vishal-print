    ...
    <div class="banner-wrapper-inner">
        <div class="breadcrumb-trail breadcrumbs">
            <ul class="trail-items breadcrumb">
                ...
                <li class="trail-item"><a href="#"><span style="color:#fff;">Blog</span></a></li>
                <li class="trail-item trail-end active"><span style="color:#fff;">Single Post</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <article
                    ...
                    <div class="single-post-thumb">
                        <div class="post-thumb">
                            <img src="assets/images/vishal-print/blog-detail.jpg"
                        ...
                        <div id="gallery-1" class="gallery galleryid-195 gallery-columns-2 gallery-size-full">
                            <figure class="gallery-item">
                                <div class="gallery-icon landscape">
                                    <a href="#"><img
                                            src="assets/images/vishal-print/blog-detail1.jpg"
                            ...
                            <figure class="gallery-item">
                                <div class="gallery-icon landscape">
                                    <a href="#"><img
                                            src="assets/images/vishal-print/blog-detail2.jpg"
                                            class="attachment-full size-full" alt="img"></a>
                                </div>
                            </figure>
                        </div>
