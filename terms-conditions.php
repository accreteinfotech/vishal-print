...
<head>
    ...
    <title>Vishal Sarees | Terms & Conditions</title>
	<?php 
	include('head.php');
	?>
</head>
            ...
            <div class="main-content col-md-12 col-sm-12">
                <article
                    ...
                    <div class="single-post-info">
                        <h2 class="post-title"><a href="#">Terms & Conditions</a></h2>
                    ...
                    <div class="post-content">
                        <div id="output">
                            ...
                            <p>Our App Registration retailer and wholesaler Data we are not misuse.</p>
                            <p>Secondly we collect Mobile number and Email for verify our side that retailer or wholesaler who register with us is our exisiting retailer or wholesaler if we find that he our exisiting retailer or wholesaler that we approved them and than provide username and password for our existing  retailer and wholesaler email only.</p>
                        </div>
