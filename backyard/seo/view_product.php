                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from product p,category c,inventory i,priority pri where pri.priority_id=p.priority_id and p.category_id=c.category_id and p.inventory_id=i.inventory_id and c.category_delete=0 and p.product_delete=0");
											if($sql)
											{
												foreach($sql as $cat)
												{
