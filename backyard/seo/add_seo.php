...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Add Page SEO</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Add Page SEO</h4>
                                    ...
                                    <form action="Update-Seo" name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
                                      <div class="form-group">
                                            ...
                                            <select name="page_seo_id" id="page_seo_id" class="form-control">
												<?php
													...
													if($link->count > 0)
													{
														...
														{
															?>
																<option value="<?php echo $cat['page_seo_id']; ?>"><?php echo $cat['page_seo_name']; ?></option>
															<?php
														}
													}
												?>
										 ...
										 <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="page_seo_title" name="page_seo_title" placeholder="Title">
										</div>
										<div class="form-group">
                                            <label for="exampleInputName1">Meta Description</label>
                                            <textarea class="form-control" id="page_seo_description" name="page_seo_description" placeholder="Description"></textarea>
										</div>
										<div class="form-group">
                                            <label for="exampleInputName1">Meta Keywords</label>
                                            <textarea class="form-control" id="page_seo_keywords" name="page_seo_keywords" placeholder="Keywords"></textarea>
										</div>
										 <div class="form-group">
                                            <label for="exampleInputName1">Meta Author</label>
                                            <input type="text" class="form-control" id="page_seo_author" name="page_seo_author" placeholder="Author">
										</div>
										<h5 class="card-title">Meta Og Tag</h5>
										<div class="form-group">
                                            <label for="exampleInputName1">Meta Og Title</label>
                                            <input type="text" class="form-control" id="page_seo_og_title" name="page_seo_og_title" placeholder="Title">
										</div>
										<div class="form-group">
                                            <label for="exampleInputName1">Meta Og Description</label>
                                            <textarea class="form-control" id="page_seo_og_description" name="page_seo_og_description" placeholder="Description"></textarea>
										</div>
										<div class="form-group">
                                            <label for="exampleInputName1">Meta Og URL</label>
                                            <input type="text" class="form-control" id="page_seo_og_url" name="page_seo_og_url" placeholder="URL">
										</div>
