...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Search Consol</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Search Consol</h4>
                                   <?php
										
										$ad=$link->rawQueryOne("select * from seo_codes where seo_codes_id=?",array(4));
									?>
                                    <form action="update_search.php"  name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
										<div class="form-group">
                                            <label for="exampleInputName1">Search Consol Code</label>
