...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Google Analytics</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                   ...
                                   <?php
										...
										$ad=$link->rawQueryOne("select * from seo_codes where seo_codes_id=?",array(1));
									?>
                                    <form action="update_google.php"  name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
										<div class="form-group">
                                            <label for="exampleInputName1">Google Analytics Code</label>
