...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Leads</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from leads");
											if($sql)
											{
												foreach($sql as $cat)
												{
													?>
														...
														<td><?php echo $cat['leads_name']; ?></td>
														<td><?php echo $cat['leads_product']; ?></td>
														<td><?php echo date('d M, Y',strtotime($cat['leads_time'])); ?></td>
														<td><?php echo $cat['leads_mail']; ?></td>
														<td><?php echo $cat['leads_address']; ?></td>
														<td><?php echo $cat['leads_phone']; ?></td>
