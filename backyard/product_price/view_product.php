                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from product p,category pt,inventory i where p.inventory_id=i.inventory_id and p.category_id=pt.category_id and pt.category_delete=0 and p.product_delete=0");
											if($sql)
											{
												foreach($sql as $cat)
												{
													...
													<tr>
														...
														<td><a href="view_product_price.php?pid=<?php echo $cat['product_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/eye.png"></a></td>
