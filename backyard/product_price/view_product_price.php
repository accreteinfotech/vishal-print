                                ...
                                <div class="card-body">
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
										...
										<?php
											...
											$sql=$link->rawQuery("select * from product_price p,inventory i,product pr,color c where p.inventory_id=i.inventory_id and p.product_id=pr.product_id and
                                                 p.color_id = c.color_id and p.product_id=?",array($product_id));
											if($sql)
											{
												foreach($sql as $cat)
												{
													...
													<tr>
														...
														<td><a  href="edit_product_price.php?cid=<?php echo $cat['product_price_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
														<td><a onClick='javascript:confirmationDelete($(this));return false;' href="delete_product_price.php?cid=<?php echo $cat['product_price_id'];?>&pid=<?php echo $cat['product_id']; ?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
