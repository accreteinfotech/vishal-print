                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from product p,category pt where p.category_id=pt.category_id and pt.category_delete=0 and p.product_delete=0");
											if($sql)
											{
												foreach($sql as $cat)
												{
													...
													<tr>
														...
														<td>&#8377 <?php echo $cat['product_price']; ?></td>
