...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Size</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Size</h4>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
										...
										<?php
											...
											$sql=$link->rawQuery("select * from product_size ps,inventory i,product pr where ps.inventory_id=i.inventory_id and ps.product_id=pr.product_id and
                                                ps.product_id=?",array($product_id));
											if($sql)
											{
												foreach($sql as $cat)
												{
													...
													<tr>
														...
														<td><?php echo $cat['inventory_type']; ?></td>
														<td><a  href="edit_product_size.php?cid=<?php echo $cat['product_size_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
														<td><a onClick='javascript:confirmationDelete($(this));return false;' href="delete_product_size.php?cid=<?php echo $cat['product_size_id'];?>&pid=<?php echo $cat['product_id']; ?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
