...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Edit Product Size</title>
                       ...
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                   ...
                                   <?php
										$ad=$link->rawQueryOne("select * from product_size ps where 
											ps.product_size_id=?",array($_REQUEST['cid']));
										if($link->count > 0)
										{
											
												$product_size_id=$ad['product_size_id'];
												$inventory_id=$ad['inventory_id'];
												$product_id=$ad['product_id'];
										}
									?>
                                    <form action="update_product_size.php" name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
                                         <div class="form-group">
											<input type="hidden" id="product_size_id" name="product_size_id" class="form-control" value="<?php echo $product_size_id;?>">
										</div>
