                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
                                           // $sql=$link->rawQuery("select * from product p,category pt where p.category_id=pt.category_id and pt.category_delete=0 and 
                                                //p.product_delete=0");
											$sql=$link->rawQuery("select * from product p,category c where p.category_id=c.category_id and is_active1=1 and product_delete=0");
											if($sql)
											{
												foreach($sql as $cat)
												{
													...
													<tr>
														...
														<td><?php if($cat['priority_id']==1){ echo "Feature";}else{echo "Regular";} ?></td>
														<td><a href="view_product_size.php?pid=<?php echo $cat['product_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/eye.png"></a></td>
