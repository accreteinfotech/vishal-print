...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Add Material</title>
                       ...
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="Insert-Material" name="f1" id="formsubmit" method="POST">
                                        <div class="form-group">
                                            <label for="exampleInputName1">Material Name</label>
                                            <input type="text" onkeyup="aliascheck(this.value);" class="form-control" id="material_name" name="material_name" placeholder="Material Name">
