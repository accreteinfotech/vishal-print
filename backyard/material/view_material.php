...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Material</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Material List</h4>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from material where material_delete=0");
											if($sql)
											{
												foreach($sql as $cat)
												{
													?>
													<tr>
														<td><?php echo $cat['material_name']; ?></td>
														 
													<td><a href="Edit-Material/<?php echo $cat['material_id']; ?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
													<td><a onClick='javascript:confirmationDelete($(this));return false;' href="Delete-Material/<?php echo $cat['material_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
