    ...
    ******* Page Wrapper Area Start **********
                                ...
                                <div class="card-body">
                                   ...
                                   <?php
										...
										if($link->count > 0)
										{
												...
												$category_alias=$ad['category_alias'];
												$category_id=$ad['category_id'];
												$category_icon=$ad['category_icon'];
												$category_image=$ad['category_image'];
                                    ...
                                    <form action="Update-Category"  name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" onkeyup="aliascheck(this.value,<?php echo $category_id ?>);" class="form-control" id="category_alias" name="category_alias" value="<?php echo $category_alias;?>" placeholder="Category Alias">
    ...
    color: #dc3545;"></span>
										...
										<div class="form-group">
											...
											<option value="0" <?php if($parent_category_id==0){ echo "selected"; } ?>>None</option>
												<?php
													$sql=$link->rawQuery("select * from category where category_delete=0 and category_id!=?",array($category_id));
													if($link->count > 0)
													{
														foreach($sql as $cat)
														{
															?>
																<option value="<?php echo $cat['category_id']; ?>"  <?php if($cat['category_id']==$parent_category_id){ echo "selected"; } ?>><?php echo $cat['category_name']; ?></option>
															<?php
														}
													}
												?>
										 ...
										 <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="category_icon" id="category_icon" onchange="readURL1(this);">
                                           </div>
										    <div class="col-sm-12" style="padding:10px;">
											<img id="imagePreview1" style="height:180px;width:250px;border-style:dotted;"  src="../images/category_icon/<?php echo $category_icon;?>" height="260px"> 
											</div>
                                       <div class="form-group">
                                            <label>Category Cover Image</label>
                                            <input type="file" class="form-control" name="category_image" id="category_image" onchange="readURL2(this);"  >
                                        </div>
										<div class="col-sm-12" style="padding:10px;">
											<img id="imagePreview3" style="height:180px;width:250px;border-style:dotted;"  src="../images/category_image/<?php echo $category_image;?>" height="260px"> 
										</div>
                                        <div class="form-group">
