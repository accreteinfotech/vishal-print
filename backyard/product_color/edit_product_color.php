...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Edit Product Color</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Product Color</h4>
                                   <?php
										$ad=$link->rawQueryOne("select * from product_color pc where  pc.product_color_id=?",array($_REQUEST['cid']));
										if($link->count > 0)
										{
											
												$product_color_id=$ad['product_color_id'];
									...
									?>
                                    <form action="update_product_color.php" name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
                                         <div class="form-group">
											<input type="hidden" id="product_color_id" name="product_color_id" class="form-control" value="<?php echo $product_color_id;?>">
										</div>
