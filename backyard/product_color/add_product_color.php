...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Add Product Color</title>
                       ...
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                   ...
                                   <form action="insert_product_color.php" name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
											...
											<option value="">-- select color --</option>
												<?php
													...
													if($sql)
													{
														...
														{
															?>
															<option value="<?php echo $cat['color_id']; ?>"><?php echo $cat['color_name']; ?></option>
															<?php
														}
													}
												?>
		...
		$( document ).ready( function () {
			$( "#formsubmit" ).validate( {
				...
				messages: {
					...
					product_color: "Please enter product color",
