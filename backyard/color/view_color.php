											...
											if($sql)
											{
												foreach($sql as $cat)
												{
													...
													<tr>
														...
														<td><?php echo $cat['color_code']; ?></td>
														 <!--<?php
															if($cat['is_active']==1)
															{
																$flag=1;
																?>
																	<td><a href="inactive.php?cid=<?php echo $cat['color_id'];?>" class="btn btn-neutral" style="background-color:#00b200;color:#ffffff;"><?php echo "Active";?></a></td>
															...
															elseif($cat['is_active']==0)
															{
																...
																?>
																	...
																	<td><a href="active.php?cid=<?php echo $cat['color_id'];?>" class="btn btn-neutral" style="background-color:#FF0000;color:#ffffff;"><?php echo "Inactive";?></a></td>
																<?php
															}
															else{
																?>
													...
													<td><a href="Edit-Color/<?php echo $cat['color_id']; ?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
														<td><a onClick='javascript:confirmationDelete($(this));return false;' href="Delete-Color/<?php echo $cat['color_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
