                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Size List</h4>
										...
										<?php
											...
											if($sql)
											{
												foreach($sql as $cat)
												{
													...
													<td><a href="Edit-Inventory/<?php echo $cat['inventory_id']; ?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
													<td><a onClick='javascript:confirmationDelete($(this));return false;' href="Delete-Inventory/<?php echo $cat['inventory_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
