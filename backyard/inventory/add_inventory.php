...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Add Size</title>
...
<body>
    ...
    ******* Page Wrapper Area Start **********
                       ...
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="Insert-Inventory" name="f1" id="formsubmit" method="POST">
                                        <div class="form-group">
                                            <label for="exampleInputName1">Size Name</label>
                                            <input type="text" class="form-control" onkeyup="aliascheck(this.value);" id="inventory_type" name="inventory_type" placeholder="Size Name">
    ...
    color: #dc3545;"></span>
                                        ...
                                        <input id="reg" type="submit" class="btn btn-primary mr-2" value="Submit">
		...
		$.ajax({
		 type: "POST",
		   ...
		   success: function(data)
		   {
				if(data == 'already')
				{
					$("#rerror").html("Existing Inventory");
