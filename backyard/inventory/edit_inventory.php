...
?>
<head>
	<base href="<?php echo $site_url; ?>backyard/inventory/">
    <meta charset="UTF-8">
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Edit Size</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                   ...
                                   <?php
										...
										$ad=$link->rawQueryOne("select * from inventory where inventory_id=?",array($_REQUEST['cid']));
										if($link->count > 0)
										{
									...
									?>
                                    <form action="Update-Inventory" name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
                                         <div class="form-group">
											<input type="hidden" id="inventory_id" name="inventory_id" class="form-control" value="<?php echo $inventory_id;?>">
										</div>
										<div class="form-group">
                                            <label for="exampleInputName1">Size Name</label>
                                            <input type="text" onkeyup="aliascheck(this.value,<?php echo $inventory_id; ?>);" class="form-control" id="inventory_type" name="inventory_type" placeholder="Size Name" value="<?php echo $inventory_type;?>" >
